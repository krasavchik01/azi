...
4. **Добавьте переменные окружения:**
   ...
   **Опционально (для реалистичного голоса):**
   ```
   ELEVENLABS_API_KEY=ваш_ключ_elevenlabs
   ```
   *Без ElevenLabs будет использоваться браузерный TTS*
...
### ElevenLabs API Key (опционально, для реалистичного голоса):
1. Зарегистрируйтесь: https://elevenlabs.io/
2. Перейдите в Profile → API Keys
3. Скопируйте ваш API key
4. **Бесплатный план:** 10,000 символов в месяц (хватит для тестирования!)
5. Если не указать - будет использоваться браузерный TTS

**Преимущества ElevenLabs:**
- 🎙️ Реалистичный женский голос с эмоциями
- 🌍 Отличная поддержка русского языка
- 🎭 Живая интонация и выразительность
- ⚡ Быстрая генерация
